...
import RouteBreadcrumbHeader from "@/sections/header/breadcrumbs/RouteBreadcrumbHeader";
import Header from "@/sections/header/header";

export default function Dashboard() {
  const [isCollapsed, setIsCollapsed] = useState(true);
  const toggleMenu = () => {
    console.log("toggling menu", isCollapsed);
  ...
  return (
    <TooltipProvider delayDuration={0}>
      <div className="flex h-screen w-full flex-row bg-muted/40">
        ...
        <div
          className={cn(
            "flex flex-col sm:gap-4 sm:py-4 w-full h-full overflow-auto"
          )}
        >
          <Header />
